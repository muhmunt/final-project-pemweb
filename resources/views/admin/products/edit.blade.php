...
<div class="page-breadcrumb">
    <div class="row align-items-center">
        <div class="col-6">
            ...
            <h1 class="mb-0 fw-bold">Edit a Product</h1>
...
{{-- form --}}
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route("products.update", $product->id) }}" class="form-horizontal form-material mx-2">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="number" name="stock" placeholder=""
                                class="form-control form-control-line" value="{{ $product->stock }}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="submit" class="btn btn-success text-white" value="Update Product">
